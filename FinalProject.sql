...
componentType_technicalSystem_id varchar(1),
...
--constraint componentType_technicalSystem_id_fk
--foreign key (componentType_technicalSystem_id) references componentType, 
...
--something is wrong with the above key:column "element_componenttype_technicalsystem_id" referenced in foreign key constraint does not exist
)
;
--element_pk primary key(componentType_technicalSystem_id, compontentType_id,....)
